...
(async function () {
  ...
  recognizer = SpeechCommands.create('BROWSER_FFT', undefined, 'https://storage.googleapis.com/tfjs-models/tfjs/speech-commands/v0.2/browser_fft/18w/model.json', 'https://storage.googleapis.com/tfjs-models/tfjs/speech-commands/v0.2/browser_fft/18w/metadata.json');
